...
insert  into `orders`(`id`,`clientId`,`cost`,`paid`,`date`,`number`,`typeId`,`pointId`,`managerId`,`statusId`,`outDate`) values (1,227,800.00,500.00,'2015-10-31',800,1,1,2,1,'2015-10-31');
...
insert  into `point`(`id`,`label`) values (1,'Промагро основной'),(2,'Дружба Старый Оскол'),(3,'Княжна Губкин'),(4,'Чернянка');
