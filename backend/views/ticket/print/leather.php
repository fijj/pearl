        ...
        <table class="ticket-data">
            ...
            <? foreach ($models as $key => $model): ?>
                ...
                $array2 = [
                    ...
                    ($model->param34) ? $model->getAttributeLabel('param34_1') : null,
                    ($model->param34) ? $model->getAttributeLabel('param34_2') : null,
                    ($model->param34) ? $model->getAttributeLabel('param34_3') : null,
                    ($model->param34) ? $model->getAttributeLabel('param34_4') : null,
                    ($model->param34) ? $model->getAttributeLabel('param34_5') : null,
                    ($model->param34) ? $model->getAttributeLabel('param34_6') : null,
                    ($model->param34) ? $model->getAttributeLabel('param34_7') : null,
                    ($model->param34) ? $model->getAttributeLabel('param34_8') : null,
                    ($model->param34) ? $model->getAttributeLabel('param34_9') : null,
                    ($model->param34) ? $model->getAttributeLabel('param34_10') : null,
                    ($model->param34) ? $model->getAttributeLabel('param34_11') : null,
                    ($model->param34) ? $model->getAttributeLabel('param34_12') : null,
                    ($model->param34) ? $model->getAttributeLabel('param34_13') : null,
                    ($model->param34) ? $model->getAttributeLabel('param34_14').'('.$model->param34_14n.')' : null,
                    ($model->param34) ? $model->getAttributeLabel('param34_15') : null,
                    ($model->param34) ? $model->getAttributeLabel('param34_16') : null,
                    ($model->param34) ? $model->getAttributeLabel('param34_17') : null,
                    ($model->param34) ? $model->getAttributeLabel('param34_18') : null,
                    ($model->param34) ? $model->getAttributeLabel('param34_19') : null,
